cordova.define("cordova-plugin-x-zijinutil.ZijinUtil", function(require, exports, module) {
    function ZijinUtil() {
    }
    ...
    ZijinUtil.prototype.closeFingerprint = function (successCallback, errorCallback) {
        cordova.exec(successCallback, errorCallback, "ZijinUtil", "closeFingerprint", [{}]);
    };
    ...
    ZijinUtil.prototype.verifyFingerprint = function (charArray, successCallback, errorCallback) {
        cordova.exec(successCallback, errorCallback, "ZijinUtil", "verifyFingerprint", charArray);
    };

    ZijinUtil.prototype.loadFpData = function (charArray, successCallback, errorCallback) {
        cordova.exec(successCallback, errorCallback, "ZijinUtil", "loadFpData", charArray);
    };
